...
class MCTall():
    ...
    def train(self):
        ...
        pose_seq_d[:, :, :3] = 0
        text_upper_seq_d = text_upper_seq_d.to(self.device) if text_upper_seq_d is not None else None
        text_lower_seq_d = text_lower_seq_d.to(self.device) if text_lower_seq_d is not None else None
        text_torso_seq_d = text_torso_seq_d.to(self.device) if text_torso_seq_d is not None else None
        text_whole_seq_d = text_whole_seq_d.to(self.device) if text_whole_seq_d is not None else None
        text_simple_tag_seq_d = text_simple_tag_seq_d.to(self.device) if text_simple_tag_seq_d is not None else None
